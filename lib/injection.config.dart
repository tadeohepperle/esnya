...
import 'infrastructure/auth/auth_repository_impl.dart' as _i6;
import 'infrastructure/core/firebase_injectible_module.dart' as _i10;
...
_i1.GetIt $initGetIt(_i1.GetIt get,
  ...
  gh.lazySingleton<_i5.AuthRepository>(() => _i6.FirebaseAuthRepository(
      get<_i3.FirebaseAuth>(), get<_i4.GoogleSignIn>()));
  gh.factory<_i7.SignInFormBloc>(
      () => _i7.SignInFormBloc(get<_i5.AuthRepository>()));
  gh.lazySingleton<_i8.AppRouter>(
      () => _i8.AppRouter(get<_i5.AuthRepository>()));
  gh.factory<_i9.AuthBloc>(() => _i9.AuthBloc(get<_i5.AuthRepository>()));
  return get;
}

class _$FirebaseInjectibleModule extends _i10.FirebaseInjectibleModule {}
