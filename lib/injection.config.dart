...
import 'application/food_data/input/food_input_bloc.dart' as _i27;
...
_i1.GetIt $initGetIt(_i1.GetIt get,
  ...
  gh.lazySingleton<_i8.FoodDataRepository>(
      () =>
          _i26.FoodDataRepositoryIsolateBridge(get<_i15.Isolate2Repository>()),
      registerFor: {_isolate1});
  gh.lazySingleton<_i27.FoodInputBloc>(
      () => _i27.FoodInputBloc(
      ...
      registerFor: {_isolate1});
  gh.lazySingleton<_i12.FoodMappingRepository>(
      () => _i28.FoodMappingRepositoryIsolateBridge(
          get<_i15.Isolate2Repository>()),
      registerFor: {_isolate1});
  gh.factory<_i29.SignInFormBloc>(
      () => _i29.SignInFormBloc(get<_i24.AuthRepository>()));
  gh.lazySingleton<_i30.AppRouter>(
      () => _i30.AppRouter(get<_i24.AuthRepository>()));
  gh.factory<_i31.AuthBloc>(() => _i31.AuthBloc(get<_i24.AuthRepository>()));
  gh.lazySingleton<_i32.DashboardBloc>(
      () => _i32.DashboardBloc(
          get<_i10.FoodItemEntryBucketRepository>(), get<_i27.FoodInputBloc>()),
      registerFor: {_isolate1});
  return get;
}
