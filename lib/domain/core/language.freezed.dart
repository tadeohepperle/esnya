...
abstract class $LanguageCopyWith<$Res> {
  ...
  $Res call({String name, String nativeName, Locale locale});
}
...
class _$_Language implements _Language {
  const _$_Language(
      {required this.name, required this.nativeName, required this.locale});
  ...
  @override
  String toString() {
    return 'Language(name: $name, nativeName: $nativeName, locale: $locale)';
  }
...
abstract class _Language implements Language {
  const factory _Language(
      {required String name,
      required String nativeName,
      required Locale locale}) = _$_Language;
